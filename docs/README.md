...
| [고장수거_로드맵.md](기록/고장수거_로드맵.md) | **고장 자전거 수거의 남은 과제와 판정 기준** — 결과를 보기 전에 못박아 둔다. 🔴 우측 절단은 **추적을 앞으로 못 늘린다**(2026-04 이후 자료가 없다) — 창을 통째로 앞으로 옮겨 되살아남을 직접 잰다. 🔴 세대 퇴역은 **정비 기록 없이도 절반은 갈린다**(세대 안 층화) |
