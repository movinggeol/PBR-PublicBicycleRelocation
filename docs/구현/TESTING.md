...
파이프라인이 아예 돌지 않았습니다. 그때 만든 안전망이 지금의 627개 테스트입니다.
이후 모든 수정은 이 위에서 이뤄졌습니다.

```powershell
python -m pytest              # 전체 627개 (약 100초)
...
| **합계** | **627** | 25개 파일 · 약 120초 (`python -m pytest`) |
