...
>
> 🔴 **$N = 50$은 더 나아가 "틀렸다고 밝혀진 근거 위에 서 있다"**(2026-08-31).
> 1.21.8이 근거로 삼은 스윕은 **계획이 전부 집행된다고 가정**해 잰 것이라
> 상한을 올릴수록 좋아 보이는 자였다. 집행 기준으로 두 달을 재면 순서가
> **30 < 40 < 50 < 70**으로 뒤집힌다([EXPERIMENTS.md](EXPERIMENTS.md) 12장).
> **그런데도 50을 유지하는 이유**는 바꿀 값이 아직 정해지지 않았기 때문이다 —
> [DECISIONS.md 6-C](DECISIONS.md#6-c-후보-상한-50--더-나은-값을-알고도-아직-바꾸지-않는다-2026-08-31)에
> 적었다.
