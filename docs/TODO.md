...
12. **KPI 체계 구축**: ①~③단계 완료(1.9.3). 남은 것은
    ④ 결품 시간 시뮬레이션 → ⑤ 수요 예측 백테스트.
    **`improvement_rate`가 계획 달성률이라 실측 성격의 지표가 없는 것이 여전히 핵심 공백**이며,
    ④가 그 공백을 메웁니다([KPI.md](KPI.md) 3-B).

---

## ✅ 완료 (2026-08-11, 버전 1.9.3) — KPI 요약 테이블과 `/kpi` 화면
...
## ✅ 완료 (2026-08-11, 버전 1.9.2) — 거리 가중치 실험, 시간 예산 초과 해소
