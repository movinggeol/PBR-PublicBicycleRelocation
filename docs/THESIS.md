...
| 구분 | 상태 | 판정 |
| --- | --- | --- |
| 동작하는 시스템 | step0~4 실데이터 완주, 웹 대시보드, 테스트 228개 | ✅ 졸업작품으로 충분 |
...
| **평가의 결함 3건** | depot 복귀 누락·계획 기준 지표·요일 필터 불일치 | 🔴 [TODO.md](TODO.md) P1 |
...
| 항목 | 현재 | 할 일 |
| --- | --- | --- |
| CI | 없음 | GitHub Actions로 `pytest` 자동 실행 — 테스트 228개의 신뢰도가 올라간다 |
