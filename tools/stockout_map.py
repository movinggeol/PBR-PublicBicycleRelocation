...
⚠️ **수집 창 밖은 알 수 없다.** 창은 등록에 따라 넓어져 왔다(09~17시 → 07~22시
→ 매일 07~23시, COLLECTOR.md 2장). 지금 창이면 `_05_10`은 07~09시대만,
`_20_05`는 20~23시대만 관측되고, 09~17시로 모은 옛 날짜에는 `_20_05`가 아예
없다. 창 밖 시간을 '결품 없음'으로 읽으면 안 된다 — 이 도구는 관측이 있는
시간만 세고, 커버리지를 함께 찍는다.
