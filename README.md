...
python -m pytest              # 897개 통과 확인 (약 100초)
...
python -m pytest                 # 897개, 약 100초 (tests/ 만 수집)
```

- `tests/test_pipeline.py` (57) — 합성 데이터로 step0→step1→step2→step4를
...
| [docs/구현/TESTING.md](docs/구현/TESTING.md) | **테스트** — 897개가 무엇을 지키는지, 외부 API 수동 검증 절차 |
