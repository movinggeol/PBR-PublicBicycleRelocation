...
| 총 이동거리 | 301 km |
| 시간 예산(120분) 준수 | 9/10 클러스터 (90%) |
| 평균 불균형 개선 | **65%** (Pick 50% / Drop 77%) |

**하루 3회차 운용 결과** (05~10 / 10~15 / 15~20시)

| 회차 | 차량 | 처리 | 이동거리 | 최장 | 개선률 |
| --- | --- | --- | --- | --- | --- |
| `_05_10` | V01~V10 | 305대 | 301 km | 121.0분 | 65% |
| `_10_15` | V11~V20 | 182대 | 265 km | 86.5분 | 71% |
| `_15_20` | V21 외 9대 | 197대 | 300 km | 119.6분 | 71% |
| **합계** | **21대 전원** | **684대** | **866 km** | — | — |

회차마다 다른 차량이 나가며(로테이션), 하루면 보유 21대가 모두 최소 1회 출동합니다.

※ 25년 11월 대여이력(511,951건), 2026-08-11 실행 결과입니다.
입력 데이터·파라미터에 따라 달라집니다.

> ⚠️ 개선률은 **계획 달성률**입니다(계획이 목표 재고를 얼마나 채웠는가).
> 이용자가 실제로 자전거를 탈 수 있었는지와는 다릅니다 — [docs/KPI.md](docs/KPI.md) 참고.
