...
python -m pytest                                   # 234개 통과 확인 (약 50~80초)
...
python -m pytest                 # 234개, 약 50~80초 (tests/ 만 수집)
```
...
- `tests/test_calculations.py` (25) — **계산 단위 테스트**: 목표재고 공식(`μ + zσ`,
...
| [docs/TESTING.md](docs/TESTING.md) | **테스트** — 234개가 무엇을 지키는지, 외부 API 수동 검증 절차 |
