...
python -m pytest              # 828개 통과 확인 (약 100초)
...
- `tests/test_pipeline.py` (49) — 합성 데이터로 step0→step1→step2→step4를
...
| [docs/구현/TESTING.md](docs/구현/TESTING.md) | **테스트** — 828개가 무엇을 지키는지, 외부 API 수동 검증 절차 |
