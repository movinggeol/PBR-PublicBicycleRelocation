...
# 교통량으로 서버가 계산해 totalTime을 돌려준다. 그래서 실측 배율(**1.32배**,
# docs/분석/EXPERIMENTS.md 5-D장)은 우리 가정(25 km/h)에 오염되지 않은 값이다 —
# 그것이 이 실측의 값어치다. (첫 측정의 1.53배는 startTime을 2017년 저녁으로
# 고정한 채 잰 값이라 인용하지 않는다.)
#
