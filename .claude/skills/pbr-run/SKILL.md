...
**851개 수집 · 실패 0이 기준선이다.** cbcbox 미설치·산출물 없음 같은 환경 차이로
...
| 일일 한도 (무료 요금제) | `routeSequential30` **100건** · `routeSequential100` **50건**(2026-09-15 사용자 확인). 공식 이름은 *다중 경유지 안내* — *경유지 최적화*는 별개 API다 |
