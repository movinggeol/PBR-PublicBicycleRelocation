...
def main():
    ...
    print("    갭은 하한이다 — 시간 제한을 늘리면 커진다.")
    print("    (_05_10 실측: 10초 2.5%% -> 60초 3.8%%, 최대 10.1%% -> 16.5%%)")
    print("  · **음수 갭이 나오면 solver가 덜 푼 것이다.** greedy가 최적화를")
    print("    이길 수는 없다 — --limit-sec을 늘려 다시 재라.")
