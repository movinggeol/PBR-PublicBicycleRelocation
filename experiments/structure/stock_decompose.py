...
# 2026-08-30 측정 당시의 수집 창(09~17시)에 맞춘 기본 시간대. 창 밖 시각의 분포를
# 섞으면 문턱이 흐려진다 — 새벽은 이용이 거의 없어 |Δ|가 작고, 그만큼 문턱을 낮춰
# 잡게 된다. 현재 수집 창은 매일 07~23시이므로(docs/구현/COLLECTOR.md 2장), 그 뒤
# 자료로 검증할 때는 `--hours 7-23`을 준다.
DEFAULT_HOURS = "9-17"
